...
function main()
    ...
    println("Begin to Reading instance", instance_path)#FIXME
    qp = PDHCG.qps_reader_to_standard_form(instance_path)
    println("Reading Successful!")#FIXME
    oldstd = stdout
    println("Begin to warm up")#FIXME
    ...
    println("Begin to solve")#FIXME
    println("Instance Memory: ", sizeof(qp))#FIXME
