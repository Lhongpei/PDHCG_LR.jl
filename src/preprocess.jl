...
function scale_problem(
    ...
    #println("1b")#FIXME
    diag_tmp_var = spdiagm(0 => 1.0 ./ variable_rescaling)
    #println("1c")#FIXME
    ...
    #println("1f")#FIXME
    diag_tmp_constr = spdiagm(0 => 1.0 ./ constraint_rescaling)
    #println("1g")#FIXME
    # problem.constraint_matrix = mul!(problem.constraint_matrix, diag_tmp_constr, problem.constraint_matrix)
    # problem.constraint_matrix = mul!(problem.constraint_matrix, problem.constraint_matrix, diag_tmp_var)
