...
function optimize(
    ...
    norm_Q, number_of_power_iterations_Q = estimate_maximum_singular_value(d_problem.lorank_obj_matrix' * d_problem.lorank_obj_matrix + spdiagm(d_problem.condition))
